...
export function BentoGridSection() {
  return (
    <BentoGrid className="container py-20 mx-auto">
      {items.map((item, i) => (
        <BentoGridItem
          key={i}
          title={item.title}
...
const Skeleton = () => (
  <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-purple-200 to-purple-100"></div>
);
const items = [
  {
