    ...
    <footer class="bg-neutral-900">
      <div class="max-w-screen-xl px-4 pt-16 pb-6 mx-auto sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div class="flex justify-center text-purple-300 sm:justify-start">
              <svg
                class="h-8"
                viewBox="0 0 118 24"
                fill="none"
            ...
            <p class="max-w-md mx-auto mt-6 leading-relaxed text-center text-neutral-400 sm:max-w-xs sm:mx-0 sm:text-left">
            ...
            <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
              <li>
                <Link
                  ...
                  target="_blank"
                  class="text-purple-500 transition hover:text-purple-500/75"
                >
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span class="relative flex w-2 h-2 -mr-2">
                        ...
                        <span class="relative inline-flex w-2 h-2 bg-purple-500 rounded-full"></span>
                      </span>
                    </Link>
                  </li>
                </ul>
        ...
        <div class="pt-6 mt-12 border-t border-neutral-800">
          <div class="text-center sm:flex sm:justify-between sm:text-left">
            <p class="text-sm text-neutral-400">
              <span class="block sm:inline">All rights reserved.</span>

              <Link
                class="inline-block text-purple-500 underline transition hover:text-purple-500/75"
                href="/"
              >
                Terms & Conditions
              </Link>
            ...
            <p class="mt-4 text-sm text-neutral-500 sm:order-first sm:mt-0">
