...
export const MacbookScroll = ({ src, showGradient }) => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-[1.3] scale-[0.35] sm:scale-50"
    >
      <Lid
        src={src}
        scaleX={scaleX}
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[32rem] bg-neutral-200 dark:bg-gray-400 rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
